    ...
    <div className='fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50'>
      <div className='bg-white p-6 rounded-lg shadow-lg w-1/4 h-2/3 flex flex-col items-center xs:w-10/12 xs:h-5/6 sm:w-2/3 sm:h-3/4 md:w-2/4 md:h-3/4 xl:h-3/4'>
        ...
        <div className='w-full flex flex-col'>
          ...
          />
          <label className='text-lg font-bold mb-1 text-left xs:mt-3'>Email</label>
          <input
            type='email'
            name='email'
          ...
          />
          <label className='text-lg font-bold mb-1 text-left xs:mt-3'>Password</label>
          <input
            type='password'
            name='password'
        ...
        <div className='flex justify-between items-center w-full mt-4 xs:mt-10'>
          ...
          <div className='flex flex-col flex-wrap break-words justify-center items-center'>
            ...
            <button
              ...
              hover:from-indigo-800 hover:to-indigo-950 min-h-12 h-auto flex flex-wrap break-words mr-4 ml-16 mt-2 mb-2 px-4 py-2
        ...
        <div className='flex justify-evenly w-full mt-12 h-12 xs:h-10 xs:w-11/12 xs:mt-10'>
          <button
            onClick={onClose}
